...
class School_Portal():
    db_name = (r'C:\Users\nachi\OneDrive\Desktop\SQLiteDatabaseBrowserPortable\Data\student.db')
    ...
    def __init__(self,root):
        ...
        self.photo = PhotoImage(file='C://Users//nachi//OneDrive//Documents//Python_pdf//Database Managemant System//logo.png')
        self.label = Label(image=self.photo)
        self.label.grid(row=0,column=0)

        self.label1 = Label(font=('arial',15,'bold'),text='School Mangment',fg='dark blue')
        ...
        self.lblInfo.grid(row = 10, column= 0, columnspan= 3,sticky=W)
        tick()
